...
# input arguments:
parser = argparse.ArgumentParser(description='Test muon ID reweighter')
...
muon_mask = muonselection(events.Muon, selectionid='ttwloose_tight')
print('Number of events: {}'.format(len(events)))
print('Number of selected leptons: {}'.format(ak.sum(muon_mask)))

# make and evaluate a reweighter
reweighter = MuonIDReweighter(args.sffile, 'Medium')
