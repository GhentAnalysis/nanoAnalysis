...
from reweighting.electronrecoreweighter import ElectronRecoReweighter

# input arguments:
parser = argparse.ArgumentParser(description='Test electron reco reweighter')
...
reweighter = ElectronRecoReweighter(args.sffile, year)
